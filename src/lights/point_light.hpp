...
namespace RT_ISICG
{
	...
	{
	  public:
		PointLight( const Vec3f p_positon, const Vec3f p_color, const float p_power = 1.f )
			: BaseLight( p_color, p_power ), _position( p_positon )
		{
		}
		...
		{
			Vec3f vecPHitToLight = _position - p_point;
